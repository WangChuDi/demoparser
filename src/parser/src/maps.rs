...
pub static CUSTOM_PLAYER_PROP_IDS: phf::Map<&'static str, u32> = phf_map! {
    ...
    "usercmd_command_number" => USERCMD_COMMAND_NUMBER,
    "usercmd_server_tick_executed" => USERCMD_SERVER_TICK_EXECUTED,
    "usercmd_legacy_command_number" => USERCMD_LEGACY_COMMAND_NUMBER,
    "usercmd_base_client_tick" => USERCMD_BASE_CLIENT_TICK,
    "usercmd_prediction_offset_ticks_x256" => USERCMD_PREDICTION_OFFSET_TICKS_X256,
    "usercmd_up_move" => USERCMD_UPMOVE,
    "usercmd_random_seed" => USERCMD_RANDOM_SEED,
    "usercmd_move_crc" => USERCMD_MOVE_CRC,
    "usercmd_cmd_flags" => USERCMD_CMD_FLAGS,
    "usercmd_execution_notes" => USERCMD_EXECUTION_NOTES,
    "usercmd_attack1_start_history_index" => USERCMD_ATTACK_START_HISTORY_INDEX_1,
    "usercmd_attack2_start_history_index" => USERCMD_ATTACK_START_HISTORY_INDEX_2,
    "usercmd_is_predicting_body_shot_fx" => USERCMD_IS_PREDICTING_BODY_SHOT_FX,
    "usercmd_is_predicting_head_shot_fx" => USERCMD_IS_PREDICTING_HEAD_SHOT_FX,
    "usercmd_is_predicting_kill_ragdolls" => USERCMD_IS_PREDICTING_KILL_RAGDOLLS,
    "usercmd_transport_client_tick" => USERCMD_TRANSPORT_CLIENT_TICK,
    "usercmd_pawn_entity_handle" => USERCMD_PAWN_ENTITY_HANDLE,
    "usercmd_player_slot" => USERCMD_PLAYER_SLOT,
    "usercmd_subtick_move_analog_forward_delta" => USERCMD_SUBTICK_MOVE_ANALOG_FORWARD_DELTA,
    "usercmd_subtick_move_analog_left_delta" => USERCMD_SUBTICK_MOVE_ANALOG_LEFT_DELTA,
    "usercmd_subtick_move_button" => USERCMD_SUBTICK_MOVE_BUTTON,
    "usercmd_subtick_move_when" => USERCMD_SUBTICK_MOVE_WHEN,
    "usercmd_subtick_move_pitch_delta" => USERCMD_SUBTICK_MOVE_PITCH_DELTA,
    "usercmd_subtick_move_yaw_delta" => USERCMD_SUBTICK_MOVE_YAW_DELTA,
...
pub static TYPEHM: phf::Map<&'static str, PropType> = phf_map! {
    ...
    "usercmd_command_number" => PropType::Player,
    "usercmd_server_tick_executed" => PropType::Player,
    "usercmd_legacy_command_number" => PropType::Player,
    "usercmd_base_client_tick" => PropType::Player,
    "usercmd_prediction_offset_ticks_x256" => PropType::Player,
    "usercmd_up_move" => PropType::Player,
    "usercmd_random_seed" => PropType::Player,
    "usercmd_move_crc" => PropType::Player,
    "usercmd_cmd_flags" => PropType::Player,
    "usercmd_execution_notes" => PropType::Player,
    "usercmd_attack1_start_history_index" => PropType::Player,
    "usercmd_attack2_start_history_index" => PropType::Player,
    "usercmd_is_predicting_body_shot_fx" => PropType::Player,
    "usercmd_is_predicting_head_shot_fx" => PropType::Player,
    "usercmd_is_predicting_kill_ragdolls" => PropType::Player,
    "usercmd_transport_client_tick" => PropType::Player,
    "usercmd_pawn_entity_handle" => PropType::Player,
    "usercmd_player_slot" => PropType::Player,
    "usercmd_subtick_move_analog_forward_delta" => PropType::Custom,
    "usercmd_subtick_move_analog_left_delta" => PropType::Custom,
    "usercmd_subtick_move_button" => PropType::Custom,
    "usercmd_subtick_move_when" => PropType::Custom,
    "usercmd_subtick_move_pitch_delta" => PropType::Custom,
    "usercmd_subtick_move_yaw_delta" => PropType::Custom,
